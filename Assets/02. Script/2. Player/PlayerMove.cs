...
{
    [Header("??????占썩닪占??????占썩닪????????占썩닪??占쏙옙???????占썩닪??耀붾겦維?????轅붽틓??????????占쎈츧?????")]
    [SerializeField]
    private float playerpos = 0;

    [Header("????占썩닪????戮곕㎍???????占썩닪??占쏙옙???????占썩닪??耀붾겦維?????轅붽틓??????????占쎈츧?????")]
    [SerializeField]
    private float waterplayerpos = 0;

    [Header("????占썩닪????戮곕㎍??????占쎈츧????????占썩닪????占쎈뭶???轅붽틓????占???")]
    [SerializeField]
    private float waterplayerMaxValue = 0;

    [SerializeField, Tooltip("PlayerState?? ?????占썩닪??占쎌땡筌뚯슜占???占?占쏙옙?????????占쎄끽維뽳쭩???占쎈け???")]
    ...
    /// <summary>
    /// ???????????????????????????????????熬곣뫖利당춯??占썲퐲??????占?占???????????????占썬꺂?占썰틠??怨몄젦???????????????????????汝뷴젆?占??誘좑옙???????????????????
    /// </summary>
    ...
    /// <summary>
    /// ???????????????????猷몄굣????????????????????????????熬곣뫖利당춯??占썲퐲??????占?占???????????????占썬꺂?占썰틠??怨몄젦?????????????
    /// </summary>
    ...
    #region ??????占썩닪占??????占썩닪?????????????占쎌뒧????????占썩닪???????占쎌뒧????
    /// <summary>
    /// ????占썩닪?管占????????占쎈븶??? ?占??????????占쎈븶?????占쎌뒭????
    /// </summary>
    ...
    /// <summary>
    /// ?占쎌떝?占썹몭??袁㏉떄?????釉먮빱??????占썩닪?????占쎄끽維뽳쭩??????占썩닪占?????占썩닪???
    /// </summary>
    ...
    /// <summary>
    /// ?????占썩닪???占?????占썩닪占????? ????占쎌뺏占?????占썩닪占?????占썩닪?管???????占썩닪???
    /// </summary>
