...
{
    [Header("?????????モ닪?????녿㎍?????????モ닪?????????????モ닪???????モ닪筌???????????モ닪????????됰Ŧ??怨뺢께???????????븐뼐????????????????モ닪?管異?????")]
    [SerializeField]
    private float playerpos = 0;

    [Header("???????モ닪???????꿔꺂??????????????モ닪???????モ닪筌???????????モ닪????????됰Ŧ??怨뺢께???????????븐뼐????????????????モ닪?管異?????")]
    [SerializeField]
    private float waterplayerpos = 0;

    [Header("???????モ닪???????꿔꺂?????????????モ닪?管異???????????モ닪?????????モ닪????????븐뼐???????????")]
    [SerializeField]
    private float waterplayerMaxValue = 0;

    [SerializeField, Tooltip("PlayerState?? ????????モ닪???????モ닪?????釉????????????モ닪筌?????????????モ닪???獄쏅챶留덌┼??????????モ닪?????")]
    ...
    /// <summary>
    /// ????モ닪??????モ닪??륁땡?????袁ㅻ쇀????????椰???????????モ닪??????????モ닪???獄쏅챶留덌┼?????????????モ닪?????녿㎍????????モ닪?????
    /// </summary>
