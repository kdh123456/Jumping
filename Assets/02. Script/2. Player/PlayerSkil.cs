...
public class PlayerSkil : Player
{
    ...
    public void Fire()
    {
        ...
        fireBall.transform.DOMove((isFacing ? Vector3.left : Vector3.right) * 10, 1) // ??????ã™Á≠???????ã™Á≠????Î∞∏„éç? ??????ã™Á≠????Î∞∏„éç?
