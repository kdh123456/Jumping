...
public class PlayerSkil : MonoBehaviour
{
    ...
    public void Fire()
    {
        ...
        fireBall.transform.DOMove((isFacing ? Vector3.left : Vector3.right) * 10, 1) // ??Ï¢éÎ£û???Ï¢éÎ£û??øÎúù? ??Ï¢éÎ£û??øÎúù?
